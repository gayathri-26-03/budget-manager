...
public class BudgetManager {
    ...
    private void loadData() {
        ...
        try (Scanner scanner = new Scanner(new File("purchases.txt"))) {
            ...
            int foodPurchaseCount = Integer.parseInt(scanner.nextLine());
            ...
            int clothPurchaseCount = Integer.parseInt(scanner.nextLine());
            ...
            int entertainmentPurchaseCount = Integer.parseInt(scanner.nextLine());
            ...
            int otherPurchaseCount = Integer.parseInt(scanner.nextLine());
        ...
        while (true) {
            ...
            switch (selection) {
                ...
                case 1:
                    ...
                    List<Product> sortedList = toSortedArray(allPurchaseList);
